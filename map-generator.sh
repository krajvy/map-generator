...
function downloadHeightData {
	...
	local cmd="phyghtmap --polygon=${POLY_FILE} --output-prefix=${DIR_TMP}/${MAP_NAME} --source=${HEIGHT_FORMAT} --pbf --jobs=2 --step=10 --line-cat=100,50 --start-node-id=20000000000 --start-way-id=10000000000 --write-timestamp --max-nodes-per-tile=0"
